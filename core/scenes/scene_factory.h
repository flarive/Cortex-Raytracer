...
public:
	...
	static std::shared_ptr<hittable> createFbxMesh(const std::string name, const point3& center, const std::string filepath, bool use_camera, scene::cameraConfig& cam_config, randomizer& rnd);
