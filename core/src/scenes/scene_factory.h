...
public:
	...
	static std::shared_ptr<hittable> createSpotLight(std::string name, const point3& pos, const vector3& dir, double cosTotalWidth, double cosFalloffStart, double intensity, color rgb, bool invisible);
};