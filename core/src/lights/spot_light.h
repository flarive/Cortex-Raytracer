...
{
public:
	spot_light(point3 position, vector3 direction, double cutoff, double falloff, double intensity, double radius, color rgb, std::string name = "SpotLight", bool invisible = true);
