...
inline double pcg_randomizer::get_real() noexcept
{
    return m_rng_distribution(m_rng);
}

inline double pcg_randomizer::get_real(const double min, const double max) noexcept
{
    return min + ((max - min) * get_real());
}

inline int pcg_randomizer::get_int(const int min, const int max) noexcept
{
...
inline vector3 pcg_randomizer::get_vector3() noexcept
{
    return vector3(get_real(), get_real(), get_real());
}

inline vector3 pcg_randomizer::get_vector3(const double lower, const double upper) noexcept
{
    return vector3(
...
inline vector3 pcg_randomizer::get_in_unit_sphere() noexcept
{
...
inline vector3 pcg_randomizer::get_in_unit_hemisphere(const vector3& normal) noexcept
{
...
inline vector3 pcg_randomizer::get_in_unit_disk() noexcept
{
...
inline vector3 pcg_randomizer::random_to_sphere(double radius, double distance_squared) noexcept
{
...
///// <returns></returns>
inline vector3 pcg_randomizer::random_on_hemisphere(const vector3& normal) noexcept
{
...
inline vector3 pcg_randomizer::get_unit_vector() noexcept
{
