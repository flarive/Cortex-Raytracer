...
material::material(std::shared_ptr<texture> _diffuse, std::shared_ptr<texture> _specular, std::shared_ptr<texture> _normal, std::shared_ptr<texture> _bump)
    : material(_diffuse, _specular, _normal, _bump, nullptr, 0, 0)
{
}
